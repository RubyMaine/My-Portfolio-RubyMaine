        ...
        if($user_data['social_icons']){
          ?>
            <div class="social-links">
              <a href="<?=$user_data['git']?>" target="_blank" class="twitter"><i class="bi bi-git"></i></a>
              <a href="<?=$user_data['github']?>" target="_blank" class="facebook"><i class="bi bi-github"></i></a>
              <a href="<?=$user_data['telegram_channel']?>" target="_blank" class="instagram"><i class="bi bi-telegram"></i></a>
              <a href="<?=$user_data['telegram_accaunt']?>" target="_blank" class="linkedin"><i class="bi bi-telegram"></i></a>
            </div>
          <?php
        }
      ?>
...
<!-- ======= About Me ======= -->
    ...
    <div class="about-me container">
      ...
      <div class="row">
        <div class="col-lg-4" data-aos="fade-right">
          <img src="images/<?=$user_data['profile_image']?>" class="img-fluid" alt="">
        </div>
            ...
            <div class="col-lg-3">
              <ul>
                <?php
                  ...
                  $run2 = mysqli_query($connection_db, $query2);
                  while($personal_info = mysqli_fetch_array($run2)){
                    ?>
                      <li><i class="bi bi-chevron-right"></i> <strong><?=$personal_info['label']?> :</strong></li>
                    <?php
                  }
                ?>
              </ul>
            ...
            <div class="col-lg-3">
              <ul>
                <?php
                  ...
                  while($personal_info = mysqli_fetch_array($run2)){
                    ?>
                      <li> <strong><?=$personal_info['value']?></strong></li>
                    <?php
                  }
                ?>
              </ul>
      ...
      <div class="row skills-content">
        ...
        <div class="col-lg-12">
          <?php
            ...
            $run3 = mysqli_query($connection_db, $query3);
    ...
    <div class="container">
      ...
      <div class="col-lg-6">
          ...
          <?php
              ...
              $run4 = mysqli_query($connection_db, $query4);
              ...
              <div class="resume-item">
                <h4><?=$resume['title']?></h4>
                <h5><?=$resume['time']?></h5>
                <p><em><?=$resume['organization']?></em></p>
                <p><?=$resume['about_expertnaire']?></p>
              </div>
          <?php
            }
          }
  ...
  <div class="credits">
    ...
    Designed by <a href="https://rubymaine.com/">RubyMaine</a>
  </div>
